...
dagshub_token = os.getenv("SENTIMENT")
if not dagshub_token:
    raise EnvironmentError("SENTIMENT environment variable is not set")

os.environ["MLFLOW_TRACKING_USERNAME"] = dagshub_token
os.environ["MLFLOW_TRACKING_PASSWORD"] = dagshub_token

dagshub_url = "https://dagshub.com"
repo_owner = "imayank45"
repo_name = "End-to-End-MLOps-Sentiment-Analysis-Pipeline-with-Automated-CI-CD"
...
if not os.path.exists(vectorizer_path):
    raise FileNotFoundError("❌ vectorizer.pkl not found in models/")
